...
$label_upload 	= ( empty( $atts['label-upload'] ) ? __( 'Choose/Upload image', 'formidable-schedule-export' ) : $atts['label-upload'] );
$label_remove 	= ( empty( $atts['label-remove'] ) ? __( 'Remove image', 'formidable-schedule-export' ) : $atts['label-remove'] );
