...
// Public styles
var styleSRC 					= './src/scss/formidable-schedule-export-public.scss'; // Path to main .scss file.
var styleDestination 			= './assets/css'; // Path to place the compiled CSS file.

// Admin styles
var adminStyleSRC 				= './src/scss/formidable-schedule-export-admin.scss'; // Path to admin.scss file.
...
var jsPublicFile 				= 'formidable-schedule-export-public'; // Compiled JS public file name
...
var jsAdminFile 				= 'formidable-schedule-export-admin'; // Compiled JS admin file name.
// Default set to admin i.e. admin.js.

// Images related.
var imagesSRC 					= './assets/images/*.{png,jpg,gif,svg}'; // Images source folder
